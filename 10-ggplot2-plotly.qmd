...
grafico_ggplot2 <-
  ...
  geom_point(aes(
    ...
    text = paste0(
      "País: ", NAME, "\n",
      "PIB per cápita: ", label_currency(accuracy = 1)(GDP_PC), "\n",
      "Esperanza de vida: ", label_comma(accuracy = 0.1, suffix = " años")(LIFE_EXPECTANCY)
    )
  )) +
  scale_x_continuous(labels = label_comma(), limits = c(0, NA)) +
...
grafico_dispersion_ggplot2 <-
  ...
  geom_point(aes(
    text = paste0(
      ...
      "\n",
      "PIB per cápita: ",
      scales::label_comma()(round(GDP_PC, 2)),
      "\n",
      "Esperanza de vida: ",
