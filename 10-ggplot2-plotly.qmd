...
histograma_ggplot2 <- 
  ...
  ylab("Frecuencia") +
  labs(subtitle = "Datos de 201 países", 
...
grafico_pastel_ggplot2 <-
  ...
  ggtitle("Distribución de la población por región de la ONU") +
...
plot_ly(
  ...
  layout(title = "Distribución de la población por región de la ONU") |>
  config(locale = "es")
```
