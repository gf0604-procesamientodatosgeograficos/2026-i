...
La @fig-diagrama-de-caja-componentes ilustra los componentes de un diagrama de caja en relación con el histograma de la misma variable.

```{r}
#| label: fig-diagrama-de-caja-componentes
#| fig.cap: Componentes de un diagrama de caja. Imagen de [OnkelDagobert](https://commons.wikimedia.org/wiki/File:Diagrama_de_caja.jpg) (CC BY-SA 3.0).
#| echo: false

knitr::include_graphics("img/diagrama-de-caja.jpg")
```
