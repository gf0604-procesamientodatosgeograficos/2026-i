...
El paquete ggplot2 también incluye el estilo `theme_minimal()`, que proporciona un aspecto limpio y moderno a los gráficos.

```{r}
#| label: grafico-dispersion-paises-theme-minimal
#| warning: false
#| message: false
