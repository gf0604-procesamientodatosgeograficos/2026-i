...
5. Observe el contenido del data frame en la pestaña **Environment** o desde la consola con la función `View()` (no se recomienda incluir este comando en el script).
...
15. En un gráfico estadístico, muestre la distribución de frecuencias de la variable presion. Antes de escribir el código en R, medite cuál tipo de gráfico de los vistos en clase puede ser apropiado.
16. En un gráfico estadístico, muestre los promedios de radiación por periodo. Antes de escribir el código en R, medite cuál tipo de gráfico de los vistos en clase puede ser apropiado.
17. Guarde los tres gráficos en un archivo PDF llamado `estacion-cigefi-graficos.pdf` mediante las funciones `pdf()` y `dev.off()`.
