...
1. En RStudio, cree un nuevo proyecto con la opción *File - New Project - New Directory - New Project*. Asigne al directorio el nombre `analisis-palmerpenguins` y seleccione una ubicación en su computadora para almacenarlo. Haga clic en *Create Project*; RStudio abrirá automáticamente el nuevo proyecto.
