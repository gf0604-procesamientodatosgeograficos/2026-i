...
1. Abra el proyecto `analisis-palmerpenguins` creado en el ejercicio del @sec-tidyverse. Si no lo tiene disponible, créelo siguiendo los pasos 1 a 3 de ese capítulo.
