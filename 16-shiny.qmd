...
La @fig-shiny-flujo-reactivo muestra el flujo reactivo completo de la aplicación: los dos controles de entrada (`input$especie` e `input$area`) alimentan la función reactiva `felidos_filtrados()`, cuyo resultado comparten las tres funciones `render*` que generan el mapa, el gráfico y la tabla.
